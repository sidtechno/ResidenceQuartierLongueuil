    ...
    class KD_ELEM_COUNTDOWN extends KEYDESIGN_ADDON_CLASS {
                ...
                vc_map(array(
                    ...
                    "params" => array(
                        ...
                        array(
                            "type" => "colorpicker",
                            "class" => "",
                            "heading" => esc_html__("Countdown text color", "keydesign"),
                            "param_name" => "cd_text_color",
                            "value" => "",
                            "description" => esc_html__("Choose countdown text color color. If none selected, the default color ( white ) will be used.", "keydesign"),
                        ),
        ...
        public function kd_countdown_shrt($atts, $content = null)
        {
          ...
          wp_enqueue_script('kd_countdown_script');
            ...
            $output = '<div ' .(!empty($cd_text_color) ? 'style="color: '.$cd_text_color.';" ' : ' '). 'class="countdown '.$cd_extra_class.'"  data-count-year="'.$starting_year.'" data-count-month="'.$starting_month.'" data-count-day="'.$starting_day.'" data-text-days="'.$cd_text_days.'" data-text-hours="'.$cd_text_hours.'" data-text-minutes="'.$cd_text_minutes.'" data-text-seconds="'.$cd_text_seconds.'"></div>';
