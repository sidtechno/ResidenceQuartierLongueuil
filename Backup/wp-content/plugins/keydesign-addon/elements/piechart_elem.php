                ...
                vc_map(array(
                    ...
                    "params" => array(
                        ...
                        array(
                            "type"			=>	"dropdown",
                            "class"			=>	"",
                            "heading"		=>	esc_html__("Pie bar thickness","keydesign"),
                        ...
                        array(
                            "type" => "textfield",
                            "class" => "",
                            "heading" =>	esc_html__("Pie percent", "keydesign"),
                            "param_name"	=>	"pc_value",
                            "value" => "",
                        ...
                        array(
                            "type"			=>	"dropdown",
                            "class"			=>	"",
                            "heading"		=>	esc_html__("Pie center content","keydesign"),
                        ...
                        array(
                             "type"	=>	"dropdown",
                             "class" =>	"",
                             "heading" => esc_html__("Pie link type", "keydesign"),
        ...
        public function kd_piechart_shrt($atts, $content = null)
        {
            ...
            $output .= '<div class="kd_pie_chart '.$css_animation.' '.$pc_extra_class.'" '.$animation_delay.'>';
              $output .='<span class="kd_chart" data-bar-color="'.$pc_main_color.'" '.(!empty($pc_track_color) ? 'data-track-color="'.$pc_track_color.'"' : '').' data-line-width="'.$bar_width.'" data-percent="'.$pc_value.'">';
                    ...
                    $output .= '<div class="kd-piechart-icon">';
                      $output .= $content_icon;
                    $output .= '</div>';
