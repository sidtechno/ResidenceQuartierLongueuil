...
if (!class_exists('KD_ELEM_BUTTON')) {
    class KD_ELEM_BUTTON extends KEYDESIGN_ADDON_CLASS {
        ...
        public function kd_button_shrt($atts, $content = null)
        {
            ...
            $output .= '<a '.(!empty($button_width) ? 'style="width: '.$button_width.'px;"' : '').' href="'.$href['url'].'" '.$link_target.' '.$link_title.' class="tt_button '.$button_style.' '.$button_color_scheme.' '.$button_position.' '.$css_animation.' '.$button_extra_class.'" '.$animation_delay.'>';
