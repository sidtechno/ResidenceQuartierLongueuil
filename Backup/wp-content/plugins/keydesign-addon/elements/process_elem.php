...
if (!class_exists('tek_process')) {
    class tek_process extends KEYDESIGN_ADDON_CLASS
    {
                ...
                vc_map(array(
                    ...
                    "params" => array(
                        ...
                        array(
              							...
              							"value" =>	array(
              								esc_html__( 'Inherit', 'keydesign' ) => 'inherit',
        ...
        public function kd_process_single($atts, $content = null) {
            ...
            $content_icon = $icon_color_style = $icon_size_style = $link_title = $link_target = $pss_icon = $normal_bg = $animation_delay = '';
            ...
            //Background type
            switch($pss_background_type){
      				case 'none':
      					$normal_bg = 'none';
      				break;

      				case 'custom_bg_color':
      					$normal_bg = $pss_background_color;
      				break;
            ...
            $output = '
                <li>
                    ...
                    if ($pss_display_number == "process_number_on") {
                      $output .= '<div class="pss-step-number"><span '.(!empty($pss_icon_color) ? 'style="background-color: '.$pss_icon_color.';"' : '').'>'.$pss_number.'</span></div>';
                    }
                        $output .= '<div class="pss-img-area" '.(!empty($pss_background_type) ? 'style="background-color: '.$normal_bg.';"' : '').'>'.$content_icon.'</div>
