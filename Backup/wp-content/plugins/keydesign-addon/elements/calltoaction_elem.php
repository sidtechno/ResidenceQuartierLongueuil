            ...
            $output = '<div class="kd-calltoaction '.$cta_icon_type.' '.$cta_extra_class.'" style="background-color: '.$cta_box_color.';">
                ...
                if ($cta_icon_type != "no_icon") {
                    ...
                    <div class="cta-btncontainer">
                        <a href="'.$href['url'].'" '.$link_target.' '.$link_title.' class="tt_button '.$cta_button_style.' '.$cta_button_color_scheme.' kd-animated zoomIn" data-animation-delay="200">'.$cta_button_text.'</a>
                    </div>
                </div>
            </div>';
