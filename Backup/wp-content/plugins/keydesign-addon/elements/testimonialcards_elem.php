    ...
    class tek_testimonialcards extends KEYDESIGN_ADDON_CLASS
    {
                ...
                vc_map(array(
                    ...
                    "params" => array(
                       ...
                       array(
                           "type" => "colorpicker",
                           "class" => "",
                           "heading" => esc_html__("Testimonial title text color", "keydesign"),
                           "param_name" => "tcards_testimonial_title_color",
                           "value" => "",
                           "description" => esc_html__("Choose testimonial title text color. If none selected, the default theme color will be used.", "keydesign"),
                       ),
        ...
        public function kd_testimonialcards_single($atts, $content = null) {
            ...
            $output = '<div class="key-tcards '.$css_animation.' '.$tcards_extra_class.'" '.$animation_delay.'>';
                ...
                if (!empty($tcards_testimonial_bg_color)) { $output .= '<style>.testimonial-cards .tcards_message.author-bottom:before { border-top-color:'.$tcards_testimonial_bg_color.'}</style>'; }
                $output .= '</div>';
            return $output;
        }
    }
